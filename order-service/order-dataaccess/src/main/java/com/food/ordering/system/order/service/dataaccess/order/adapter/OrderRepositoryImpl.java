...
public class OrderRepositoryImpl implements OrderRepository {
    ...
    public Order save(Order order) {
        return orderDataAccessMapper.orderEnityToOrder(orderJpaRepository
    ...
    public Optional<Order> findByTrackingId(TrackingId trackingId) {
        return orderJpaRepository.findByTrackingId(trackingId.getValue())
                .map(orderDataAccessMapper::orderEnityToOrder);
    }

    @Override
    public Optional<Order> findById(OrderId orderId) {
        return orderJpaRepository.findById(orderId.getValue()).map(orderDataAccessMapper::orderEnityToOrder);
    }
}
